...
import { STATUS_COLORS, TECH_COLORS, JOB_STATUSES, TECHNICIANS, type Job, type JobStatus, type Technician } from '@/lib/types'
    ...
    <div className="min-h-screen flex flex-col" style={{ background: '#080e1c' }}>
      ...
      <main className="flex-1 p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/jobs/new" className="pixel-btn pixel-btn-green">
            + ADD JOB
          </Link>
        </div>
        ...
        <form method="GET" className="flex gap-3 mb-5 flex-wrap items-center">
          ...
          <select name="tech" defaultValue={params.tech || ''} className="pixel-select" style={{ maxWidth: '140px' }}>
            ...
            <tbody>
              {filtered.length === 0 ? (
                ...
                filtered.map((job: Job) => {
                  ...
                  const tc = TECH_COLORS[job.technician as Technician]
                  ...
                  return (
                    <tr key={job.id}>
                      ...
                      <td>
                        <span style={{ fontSize: '7px', color: '#6b7db3' }}>{job.type}</span>
                      </td>
                      <td>
                        <span style={{ fontSize: '7px', color: '#e0e8ff' }}>{job.client}</span>
                      </td>
                      <td>
